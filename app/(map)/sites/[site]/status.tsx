...
export function StatusChip({
  ...
  return (
    <Link
      className="flex w-fit items-center gap-2 rounded-full border border-black/10 bg-black/5 py-1.5 pr-2.5 pl-3 font-medium font-sans text-base text-neutral-800 text-trim-both tracking-normal transition-colors"
      href={`/npl/${key}`}
