...
const COLLECTION_NAME = "superfund-test1";
...
await collection.upsert({
  ...
  ids: docs.map((doc) => doc.name),
});

const results = await collection.query({
  queryTexts:
    "What contaminated this site? What steps have been taken to clean it up? What is the current status?", // Chroma will embed this for you
